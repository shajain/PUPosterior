...
import numpy as np
from PUPosterior4.Net import PUPosterior3 as PUPost
from PUPosterior4.Net import Discriminator as Disc
from NN.models import BasicSigmoid as ModelPU
from NN.models import BasicSigmoid as ModelDisc
from PUPosterior4.trainer import AlternatingTrainer as AltTrain
from PUPosterior4.debug import Debug
...
class PosteriorFitting:
    DiscNetDEF = {'n_units': 10, 'n_hidden': 5, 'dropout_rate': 0.5}
    PUNetDEF = {'n_units': 10, 'n_hidden': 5, 'dropout_rate': 0.5}
    trainDEF = {'batchSize': 300, 'maxIter': 15, 'debug': False, 'rounds': 100}
