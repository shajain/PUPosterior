...
import numpy as np
from PUPosteriorSearch.Net import PUPosterior3 as PUPost
from PUPosteriorSearch.Net import Discriminator as Disc
from NN.models import BasicSigmoid as ModelPU
from NN.models import BasicSigmoid as ModelDisc
from PUPosteriorSearch.trainer import TrainerTenMedian as Trainer
from PUPosteriorSearch.debug import Debug
...
class PosteriorFitting:
    DiscNetDEF = {'n_units': 10, 'n_hidden': 5, 'dropout_rate': 0.8}
