...
class PULoss(function.Function):
    ...
    def forward(self, inputs):
        ...
        ## y_unlabeled = 1-posterior and y_positive = posterior
        positive_risk = F.sum(self.prior * positive / n_positive * F.square(y_unlabeled))
        negative_risk = F.sum((unlabeled / n_unlabeled - self.prior * positive / n_positive) * F.square(y_positive))
