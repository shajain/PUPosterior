...
class MultiLayerPerceptron(MyClassifier, Chain):
    def __init__(self, prior, dim):
        self.n_units = 10
        super(MultiLayerPerceptron, self).__init__(l1=L.Linear(dim, self.n_units, nobias=True),
                                                   b1=L.BatchNormalization(self.n_units),
                                                   l2=L.Linear(self.n_units, self.n_units, nobias=True),
                                                   b2=L.BatchNormalization(self.n_units),
                                                   l3=L.Linear(self.n_units, self.n_units, nobias=True),
                                                   b3=L.BatchNormalization(self.n_units),
                                                   l4=L.Linear(self.n_units, self.n_units, nobias=True),
                                                   b4=L.BatchNormalization(self.n_units),
                                                   l5=L.Linear(self.n_units, 1))
        self.af = F.relu
        self.prior = prior
